...
void main(){
    ...
    // 정수형 변수인 denominator는 묵시적 형변환(Implicit Type Casting)이 일어난다.
    ...
    // L-Value는 정수 R-Value가 실수인 경우에는 L-Value에서 Implicit Type Casting이 이루어지지 않는다
    // 선언한 타입 자체를 바꿀 수 없기 때문이다.
